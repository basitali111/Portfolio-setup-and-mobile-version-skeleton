...
const portfolio = [
  {
    ...
    date:"2015",
    highlights: " A daily selection of privately personalized reads; no accounts or sign-ups required",
...
const popuparray =[
  {
    ...
    deveoper:"Back End Dev",
    date:"2015",
    highlights: " Lorem Ipsum is simply dummy text of the printing and typesettin industry. Lorem Ipsum has been the industry's standard dummy text eve since the 1500s, when an unknown printer took a galley of type andbled it to make a type specimen book. It has survived not onlyfive centuries, but also the leap into electronic typesetting, remaining essent",
    image: "images/SnapshootPortfolio1.png",
    btn1: "html",
    btn2: "css",
    btn3: "javascript",
    seeproject:"https://basitali111.github.io/Portfolio-setup-and-mobile-version-skeleton/",
    seesource :"https://github.com/basitali111/Portfolio-setup-and-mobile-version-skeleton"
  },
  {
    heading: "Multi-Post Stories",
    area:"Canopy",
        ...
        <div class="project-container">
          ...
          <span class="see-source">
            <a href="${popuparray[i].seesource}" class="see-live">
              See Source <img src="imges/github.png" alt="git hub"
            /></a>
          </span>
        </div>
`;
